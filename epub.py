...
class EpubBook:
    ...
    def __writeItems(self):
        for item in self.getAllItems():
            print("{},{}".format(item.id, item.destPath))
            if item.html:
...
""" % (text, text)
    ...
    book.addTitlePage()
    book.addTocPage()
    book.addCover(r'/Users/fred/PycharmProjects/python-epub-builder/20180210_cuk400.jpg')
    
    book.addCss(r'stylesheet.css', 'main.css')
    ...
    rootDir = r'/Users/fred/PycharmProjects/python-epub-builder/test'
